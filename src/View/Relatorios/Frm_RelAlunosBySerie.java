 ...
 * @author Tadeu
 */
public class Frm_RelAlunosBySerie extends javax.swing.JFrame {

    GeraRelatorios geraRelatorios;
    SerieDAO serieDAO;

    public Frm_RelAlunosBySerie() {
        initComponents();
        setVisible(true);
        carregaSeries();
    }
    ...
    private void btn_gerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_gerarActionPerformed
        try {
            ...
            if (cbx_serie.getSelectedIndex() == 0) {
                parametros.put("SERIE", "%%");
            } else {
                parametros.put("SERIE", cbx_serie.getSelectedItem().toString());
            }
            if (geraRelatorios.imprimirRelatorioSQLNoRelatorio(parametros, "Rel_AlunosBySerie.jasper", "Relatório de Alunos Por Série") == false) {
                if (geraRelatorios.imprimirRelatorioSQLNoRelatorio(parametros, "src/Relatorios/Rel_AlunosBySerie.jasper", "Relatório de Alunos Por Série") == true) {
                }
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_RelAlunosBySerie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
