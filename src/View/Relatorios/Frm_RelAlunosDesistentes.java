 ...
 * @author Tadeu
 */
public class Frm_RelAlunosDesistentes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_inicial = new javax.swing.JFormattedTextField();
        ...
        jLabel1.setText("Data Inícial *:");

        try {
            txt_inicial.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_RelAlunosDesistentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new Frm_RelAlunosBySerie().setVisible(true);
            }
        });
    }
